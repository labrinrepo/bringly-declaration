    ...
    class Selectpicker {
      ...
      liHeight(refresh) {
        ...
        var liHeight = a.offsetHeight,
          ...
          menuStyle = typeof getComputedStyle === "function"
      ...
      clickListener() {
        ...
        this.$menu.on(
          "click",
          "li.disabled a, .popover-title, .popover-title .close",
          function (e) {
        ...
        this.$menu.on("click", ".popover-title .close", function () {
          that.$button.click();
          $(".dropdown-menu.open.show").addClass("hide");
        });
      ...
      keydown(e) {
        ...
        if (/(38|40)/.test(e.keyCode.toString(10))) {
          ...
          $items.each(function () {
            if (!$(this).hasClass("disabled")) {
              if ($.trim($(this).children("a").text().toLowerCase()).substring(
                0,
                1
